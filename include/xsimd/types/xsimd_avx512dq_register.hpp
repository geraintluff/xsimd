...
namespace xsimd
{
    ...
    {
        static constexpr bool supported() noexcept { return XSIMD_WITH_AVX512DQ > 1; }
        static constexpr bool optional() noexcept { return XSIMD_WITH_AVX512DQ == 1; }
...
#if XSIMD_WITH_AVX512CD < XSIMD_WITH_AVX512DQ
