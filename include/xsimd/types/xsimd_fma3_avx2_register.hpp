...
namespace xsimd
{
    ...
    {
        static constexpr bool supported() noexcept { return XSIMD_WITH_FMA3_AVX2 > 1; }
        static constexpr bool optional() noexcept { return XSIMD_WITH_FMA3_AVX2 == 1; }
...
#if XSIMD_WITH_AVX2 < XSIMD_WITH_FMA3_AVX2
