...
namespace xsimd
{
    ...
    {
        static constexpr bool supported() noexcept { return XSIMD_WITH_SSE4_2 > 1; }
        static constexpr bool optional() noexcept { return XSIMD_WITH_SSE4_2 == 1; }
...
#if XSIMD_WITH_SSE4_1 < XSIMD_WITH_SSE4_2
