...
namespace xsimd
{
    ...
    {
        static constexpr bool supported() noexcept { return XSIMD_WITH_AVX512CD > 1; }
        static constexpr bool optional() noexcept { return XSIMD_WITH_AVX512CD == 1; }
...
#if XSIMD_WITH_AVX512F < XSIMD_WITH_AVX512CD
